...
public class AltKeyboardDistract : MonoBehaviour
{
    ...
    void Start()
    {
        if ((paypalNoDistract.GetComponent<LowerKeyboardDistract>().timeForCSV > timeForCSV) && (paypalNoDistract.GetComponent<LowerKeyboardDistract>().timeForCSV > paypalNoDistract.GetComponent<UpperKeyboardDistract>().timeForCSV))
        {
        ...
        if ((paypalNoDistract.GetComponent<UpperKeyboardDistract>().timeForCSV > timeForCSV) && (paypalNoDistract.GetComponent<LowerKeyboardDistract>().timeForCSV < paypalNoDistract.GetComponent<UpperKeyboardDistract>().timeForCSV))
        {
            timeForCSV = paypalNoDistract.GetComponent<UpperKeyboardDistract>().timeForCSV;
            csvDocumentation = paypalNoDistract.GetComponent<UpperKeyboardDistract>().csvDocumentation;
    ...
    public void filledIn()
    {
        ...
        if (!(distraction.text.Trim().Length == 0) && !(distractionOnScreen.text.Trim().Length == 0) && !(difficultyStudy.text.Trim().Length == 0) && (distractionOnScreen.text.Equals(distraction.text)))
        {
            ...
            paypalNoDistract.GetComponent<LowerKeyboardDistract>().password = distraction.text;
            ...
            paypalNoDistract.GetComponent<LowerKeyboardDistract>().email = difficultyStudy.text;
    ...
    public void writeAlt()
    {
        if (altButton.enabled == true)
        {
            ...
            if (altKeyboard.activeSelf)
            {
                ...
                wasActive = true;
                GetComponent<AltKeyboardDistract>().enabled = false;
