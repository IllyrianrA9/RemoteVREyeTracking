...
public class DistractAlt : MonoBehaviour
{
    ...
    void Start()
    {
        if ((paypalNoDistract.GetComponent<DistractionLower>().timeForCSV > timeForCSV) && (paypalNoDistract.GetComponent<DistractionLower>().timeForCSV > paypalNoDistract.GetComponent<DistractionUpper>().timeForCSV))
        {
        ...
        if ((paypalNoDistract.GetComponent<DistractionUpper>().timeForCSV > timeForCSV) && (paypalNoDistract.GetComponent<DistractionLower>().timeForCSV < paypalNoDistract.GetComponent<DistractionUpper>().timeForCSV))
        {
    ...
    public void writeAlt()
    {
        if (altButton.enabled == true)
        {
            ...
            if (altKeyboard.activeSelf)
            {
                ...
                wasActive = true;
                GetComponent<DistractAlt>().enabled = false;
