...
public class LowerKeyboardDistract : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if ((paypalNoDistract.GetComponent<AltKeyboardDistract>().timeForCSV > timeForCSV) && (paypalNoDistract.GetComponent<UpperKeyboardDistract>().timeForCSV < paypalNoDistract.GetComponent<AltKeyboardDistract>().timeForCSV))
        {
        ...
        if ((paypalNoDistract.GetComponent<UpperKeyboardDistract>().timeForCSV > timeForCSV) && (paypalNoDistract.GetComponent<AltKeyboardDistract>().timeForCSV < paypalNoDistract.GetComponent<UpperKeyboardDistract>().timeForCSV))
        {
        ...
        if (GetComponent<AltKeyboardDistract>().wasActive == false && GetComponent<UpperKeyboardDistract>().wasActive == false)
        {
            InputSelected = 0;
        }
    ...
    public void writeAlt()
    {
        if (altButton.enabled == true)
        {
            ...
            if (lowerKeyboard.activeSelf == true)
            {
                ...
                wasActive = true;
                GetComponent<LowerKeyboardDistract>().enabled = false;
    ...
    public void writeShift()
    {
        if (shiftButton.enabled == true)
        {
            ...
            if (lowerKeyboard.activeSelf == true)
            {
                ...
                wasActive = true;
                GetComponent<LowerKeyboardDistract>().enabled = false;
                GetComponent<UpperKeyboardDistract>().enabled = true;
            }
