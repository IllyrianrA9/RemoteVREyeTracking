...
public class Alt9GAGNoD : MonoBehaviour
{
    ...
    void Start()
    {
        if ((paypalNoDistract.GetComponent<Lower9GAGNoD>().timeForCSV > timeForCSV) && (paypalNoDistract.GetComponent<Lower9GAGNoD>().timeForCSV > paypalNoDistract.GetComponent<Upper9GAGNoD>().timeForCSV))
        {
        ...
        if ((paypalNoDistract.GetComponent<Upper9GAGNoD>().timeForCSV > timeForCSV) && (paypalNoDistract.GetComponent<Lower9GAGNoD>().timeForCSV < paypalNoDistract.GetComponent<Upper9GAGNoD>().timeForCSV))
        {
    ...
    public void writeAlt()
    {
        if (altButton.enabled == true)
        {
            ...
            if (altKeyboard.activeSelf)
            {
                ...
                wasActive = true;
                GetComponent<Alt9GAGNoD>().enabled = false;
