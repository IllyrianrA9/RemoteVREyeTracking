...
public class UpperLoginPPND : MonoBehaviour
{
    ...
    void Start()
    {
        if ((paypalNoDistract.GetComponent<LowerLoginPPND>().timeForCSV > timeForCSV) && (paypalNoDistract.GetComponent<AltLoginPPND>().timeForCSV < paypalNoDistract.GetComponent<LowerLoginPPND>().timeForCSV))
        {
            timeForCSV = paypalNoDistract.GetComponent<LowerLoginPPND>().timeForCSV;
            csvDocumentation = paypalNoDistract.GetComponent<LowerLoginPPND>().csvDocumentation;
            sb = paypalNoDistract.GetComponent<LowerLoginPPND>().sb;
            InputSelected = GetComponent<LowerLoginPPND>().InputSelected;
        }

        if ((paypalNoDistract.GetComponent<AltLoginPPND>().timeForCSV > timeForCSV) && (paypalNoDistract.GetComponent<LowerLoginPPND>().timeForCSV < paypalNoDistract.GetComponent<AltLoginPPND>().timeForCSV))
        {
        ...
        file = paypalNoDistract.GetComponent<LowerLoginPPND>().file;
    ...
    public void writeAlt()
    {
        if (altButton.enabled == true)
        {
            ...
            if (upperKeyboard.activeSelf == true)
            {
                ...
                wasActive = true;
                GetComponent<UpperLoginPPND>().enabled = false;
    ...
    public void writeShift()
    {
        if (shiftButton.enabled == true)
        {
            ...
            if (upperKeyboard.activeSelf == true)
            {
                ...
                wasActive = true;
                GetComponent<UpperLoginPPND>().enabled = false;
                GetComponent<LowerLoginPPND>().enabled = true;
