...
public class AltLogin9GAG : MonoBehaviour
{
    ...
    void Start()
    {
        if ((paypalNoDistract.GetComponent<LowerLogin9GAG>().timeForCSV > timeForCSV) && (paypalNoDistract.GetComponent<LowerLogin9GAG>().timeForCSV > paypalNoDistract.GetComponent<UpperLogin9GAG>().timeForCSV))
        {
        ...
        if ((paypalNoDistract.GetComponent<UpperLogin9GAG>().timeForCSV > timeForCSV) && (paypalNoDistract.GetComponent<LowerLogin9GAG>().timeForCSV < paypalNoDistract.GetComponent<UpperLogin9GAG>().timeForCSV))
        {
    ...
    public void writeAlt()
    {
        if (altButton.enabled == true)
        {
            ...
            if (altKeyboard.activeSelf)
            {
                ...
                wasActive = true;
                GetComponent<AltLogin9GAG>().enabled = false;
