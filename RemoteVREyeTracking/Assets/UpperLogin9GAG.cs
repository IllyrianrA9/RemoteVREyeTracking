...
public class UpperLogin9GAG : MonoBehaviour
{
    ...
    void Start()
    {
        if ((paypalNoDistract.GetComponent<LowerLogin9GAG>().timeForCSV > timeForCSV) && (paypalNoDistract.GetComponent<AltLogin9GAG>().timeForCSV < paypalNoDistract.GetComponent<LowerLogin9GAG>().timeForCSV))
        {
            timeForCSV = paypalNoDistract.GetComponent<LowerLogin9GAG>().timeForCSV;
            csvDocumentation = paypalNoDistract.GetComponent<LowerLogin9GAG>().csvDocumentation;
            sb = paypalNoDistract.GetComponent<LowerLogin9GAG>().sb;
            InputSelected = GetComponent<LowerLogin9GAG>().InputSelected;
        }

        if ((paypalNoDistract.GetComponent<AltLogin9GAG>().timeForCSV > timeForCSV) && (paypalNoDistract.GetComponent<LowerLogin9GAG>().timeForCSV < paypalNoDistract.GetComponent<AltLogin9GAG>().timeForCSV))
        {
        ...
        file = paypalNoDistract.GetComponent<LowerLogin9GAG>().file;
    ...
    public void writeAlt()
    {
        if (altButton.enabled == true)
        {
            ...
            if (upperKeyboard.activeSelf == true)
            {
                ...
                wasActive = true;
                GetComponent<UpperLogin9GAG>().enabled = false;
    ...
    public void writeShift()
    {
        if (shiftButton.enabled == true)
        {
            ...
            if (upperKeyboard.activeSelf == true)
            {
                ...
                wasActive = true;
                GetComponent<UpperLogin9GAG>().enabled = false;
                GetComponent<LowerLogin9GAG>().enabled = true;
