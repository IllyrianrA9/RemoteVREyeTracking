...
public class DistractionUpper : MonoBehaviour
{
    ...
    void Start()
    {
        if ((paypalNoDistract.GetComponent<DistractionLower>().timeForCSV > timeForCSV) && (paypalNoDistract.GetComponent<DistractAlt>().timeForCSV < paypalNoDistract.GetComponent<DistractionLower>().timeForCSV))
        {
            timeForCSV = paypalNoDistract.GetComponent<DistractionLower>().timeForCSV;
            csvDocumentation = paypalNoDistract.GetComponent<DistractionLower>().csvDocumentation;
            sb = paypalNoDistract.GetComponent<DistractionLower>().sb;
            InputSelected = GetComponent<DistractionLower>().InputSelected;
        }

        if ((paypalNoDistract.GetComponent<DistractAlt>().timeForCSV > timeForCSV) && (paypalNoDistract.GetComponent<DistractionLower>().timeForCSV < paypalNoDistract.GetComponent<DistractAlt>().timeForCSV))
        {
        ...
        file = paypalNoDistract.GetComponent<DistractionLower>().file;
    ...
    public void filledIn()
    {
        ...
        if (!(distraction.text.Trim().Length == 0) && !(distractionOnScreen.text.Trim().Length == 0) && !(difficultyStudy.text.Trim().Length == 0))
        {
            ...
            paypalNoDistract.GetComponent<DistractionLower>().email = difficultyStudy.text;
    ...
    public void writeAlt()
    {
        if (altButton.enabled == true)
        {
            ...
            if (upperKeyboard.activeSelf == true)
            {
                ...
                wasActive = true;
                GetComponent<DistractionUpper>().enabled = false;
    ...
    public void writeShift()
    {
        if (shiftButton.enabled == true)
        {
            ...
            if (upperKeyboard.activeSelf == true)
            {
                ...
                wasActive = true;
                GetComponent<DistractionUpper>().enabled = false;
                GetComponent<DistractionLower>().enabled = true;
