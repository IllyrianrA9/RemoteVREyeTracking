...
public class AltLoginPPND : MonoBehaviour
{
    ...
    void Start()
    {
        if ((paypalNoDistract.GetComponent<LowerLoginPPND>().timeForCSV > timeForCSV) && (paypalNoDistract.GetComponent<LowerLoginPPND>().timeForCSV > paypalNoDistract.GetComponent<UpperLoginPPND>().timeForCSV))
        {
        ...
        if ((paypalNoDistract.GetComponent<UpperLoginPPND>().timeForCSV > timeForCSV) && (paypalNoDistract.GetComponent<LowerLoginPPND>().timeForCSV < paypalNoDistract.GetComponent<UpperLoginPPND>().timeForCSV))
        {
    ...
    public void writeAlt()
    {
        if (altButton.enabled == true)
        {
            ...
            if (altKeyboard.activeSelf)
            {
                ...
                wasActive = true;
                GetComponent<AltLoginPPND>().enabled = false;
