...
public class LowerLoginPPND : MonoBehaviour
{
    ...
    void Start()
    {
        if ((paypalNoDistract.GetComponent<AltLoginPPND>().timeForCSV > timeForCSV) && (paypalNoDistract.GetComponent<UpperLoginPPND>().timeForCSV < paypalNoDistract.GetComponent<AltLoginPPND>().timeForCSV))
        {
            timeForCSV = paypalNoDistract.GetComponent<AltLoginPPND>().timeForCSV;
            csvDocumentation = paypalNoDistract.GetComponent<AltLoginPPND>().csvDocumentation;
            sb = paypalNoDistract.GetComponent<AltLoginPPND>().sb;
            InputSelected = GetComponent<AltLoginPPND>().InputSelected;
        }

        if ((paypalNoDistract.GetComponent<UpperLoginPPND>().timeForCSV > timeForCSV) && (paypalNoDistract.GetComponent<AltLoginPPND>().timeForCSV < paypalNoDistract.GetComponent<UpperLoginPPND>().timeForCSV))
        {
            timeForCSV = paypalNoDistract.GetComponent<UpperLoginPPND>().timeForCSV;
            csvDocumentation = paypalNoDistract.GetComponent<UpperLoginPPND>().csvDocumentation;
            sb = paypalNoDistract.GetComponent<UpperLoginPPND>().sb;
            InputSelected = GetComponent<UpperLoginPPND>().InputSelected;
        }
        if (GetComponent<AltLoginPPND>().wasActive == false && GetComponent<UpperLoginPPND>().wasActive == false)
        {
            InputSelected = 0;
        }
    ...
    public void filledIn()
    {
        ...
        {
            if (paypalNoDistract.name.Equals("LoginPaypalNoDistract") && distraction.GetComponent<InputField>().text.Equals(validatePasswordNoDistract.GetComponent<LowerKeyboard>().password) && difficultyStudy.GetComponent<InputField>().text.Equals(validatePasswordNoDistract.GetComponent<LowerKeyboard>().email))
            {
                passwordValidation = "Valid";
            }

            if (paypalNoDistract.name.Equals("LoginPaypalDistract") && distraction.GetComponent<InputField>().text.Equals(validatePasswordDistract.GetComponent<LowerKeyboardDistract>().password) && difficultyStudy.GetComponent<InputField>().text.Equals(validatePasswordDistract.GetComponent<LowerKeyboardDistract>().email))
            {
                passwordValidation = "Valid";
            }
            ...
            //paypalDistract.SetActive(true);p
            //paypalNoDistract.SetActive(false);
    ...
    public void writeAlt()
    {
        if (altButton.enabled == true)
        {
            ...
            if (lowerKeyboard.activeSelf == true)
            {
                ...
                wasActive = true;
                GetComponent<LowerLoginPPND>().enabled = false;
                GetComponent<AltLoginPPND>().enabled = true;
            }
    ...
    public void writeShift()
    {
        if (shiftButton.enabled == true)
        {
            ...
            if (lowerKeyboard.activeSelf == true)
            {
                ...
                wasActive = true;
                GetComponent<LowerLoginPPND>().enabled = false;
                GetComponent<UpperLoginPPND>().enabled = true;
            }
