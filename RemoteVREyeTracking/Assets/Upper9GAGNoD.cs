...
public class Upper9GAGNoD : MonoBehaviour
{
    ...
    void Start()
    {
        if ((paypalNoDistract.GetComponent<Lower9GAGNoD>().timeForCSV > timeForCSV) && (paypalNoDistract.GetComponent<Alt9GAGNoD>().timeForCSV < paypalNoDistract.GetComponent<Lower9GAGNoD>().timeForCSV))
        {
            timeForCSV = paypalNoDistract.GetComponent<Lower9GAGNoD>().timeForCSV;
            csvDocumentation = paypalNoDistract.GetComponent<Lower9GAGNoD>().csvDocumentation;
            sb = paypalNoDistract.GetComponent<Lower9GAGNoD>().sb;
            InputSelected = GetComponent<Lower9GAGNoD>().InputSelected;
        }

        if ((paypalNoDistract.GetComponent<Alt9GAGNoD>().timeForCSV > timeForCSV) && (paypalNoDistract.GetComponent<Lower9GAGNoD>().timeForCSV < paypalNoDistract.GetComponent<Alt9GAGNoD>().timeForCSV))
        {
        ...
        file = paypalNoDistract.GetComponent<Lower9GAGNoD>().file;
    ...
    public void filledIn()
    {
        ...
        if (!(distraction.text.Trim().Length < 8) && !(distractionOnScreen.text.Trim().Length < 8) && !(difficultyStudy.text.Trim().Length == 0) && (distractionOnScreen.text.Equals(distraction.text)))
        {
            ...
            paypalNoDistract.GetComponent<Lower9GAGNoD>().password = distraction.text;
            ...
            paypalNoDistract.GetComponent<Lower9GAGNoD>().email = difficultyStudy.text;
    ...
    public void writeAlt()
    {
        if (altButton.enabled == true)
        {
            ...
            if (upperKeyboard.activeSelf == true)
            {
                ...
                wasActive = true;
                GetComponent<Upper9GAGNoD>().enabled = false;
    ...
    public void writeShift()
    {
        if (shiftButton.enabled == true)
        {
            ...
            if (upperKeyboard.activeSelf == true)
            {
                ...
                wasActive = true;
                GetComponent<Upper9GAGNoD>().enabled = false;
                GetComponent<Lower9GAGNoD>().enabled = true;
