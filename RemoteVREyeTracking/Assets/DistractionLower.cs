...
public class DistractionLower : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if ((paypalNoDistract.GetComponent<DistractAlt>().timeForCSV > timeForCSV) && (paypalNoDistract.GetComponent<DistractionUpper>().timeForCSV < paypalNoDistract.GetComponent<DistractAlt>().timeForCSV))
        {
            timeForCSV = paypalNoDistract.GetComponent<DistractAlt>().timeForCSV;
            csvDocumentation = paypalNoDistract.GetComponent<DistractAlt>().csvDocumentation;
            sb = paypalNoDistract.GetComponent<DistractAlt>().sb;
            InputSelected = GetComponent<DistractAlt>().InputSelected;
        }

        if ((paypalNoDistract.GetComponent<DistractionUpper>().timeForCSV > timeForCSV) && (paypalNoDistract.GetComponent<DistractAlt>().timeForCSV < paypalNoDistract.GetComponent<DistractionUpper>().timeForCSV))
        {
            timeForCSV = paypalNoDistract.GetComponent<DistractionUpper>().timeForCSV;
            csvDocumentation = paypalNoDistract.GetComponent<DistractionUpper>().csvDocumentation;
            sb = paypalNoDistract.GetComponent<DistractionUpper>().sb;
            InputSelected = GetComponent<DistractionUpper>().InputSelected;
        }
        if (GetComponent<DistractAlt>().wasActive == false && GetComponent<DistractionUpper>().wasActive == false)
        {
            InputSelected = 0;
        }
    ...
    public void filledIn()
    {
        ...
        if (!(distraction.text.Trim().Length < 8) && !(distractionOnScreen.text.Trim().Length < 8) && !(difficultyStudy.text.Trim().Length == 0) && (distractionOnScreen.text.Equals(distraction.text)))
        {
            ...
            paypalNoDistract.GetComponent<DistractAlt>().password = distraction.text;
            email = difficultyStudy.text;
            paypalNoDistract.GetComponent<DistractionUpper>().email = difficultyStudy.text;
            paypalNoDistract.GetComponent<DistractAlt>().email = difficultyStudy.text;
    ...
    public void writeAlt()
    {
        if (altButton.enabled == true)
        {
            ...
            if (lowerKeyboard.activeSelf == true)
            {
                ...
                wasActive = true;
                GetComponent<DistractionLower>().enabled = false;
                GetComponent<DistractAlt>().enabled = true;
            }
    ...
    public void writeShift()
    {
        if (shiftButton.enabled == true)
        {
            ...
            if (lowerKeyboard.activeSelf == true)
            {
                ...
                wasActive = true;
                GetComponent<DistractionLower>().enabled = false;
                GetComponent<DistractionUpper>().enabled = true;
            }
